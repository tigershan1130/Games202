...
var fixedTotalTime = 0.0;
var fixedDeltaTime = 0.01;
...
function GAMES202Main() {
	...
	// for better shadow bias, add in dfdy dfdx
	...
	function createGUI() {
		...
		const panelModelTrans = panelModel.addFolder('Rotation');
		panelModelTrans.add(GUIParams, 'rotationAngle').name('Model Rotation Around Y Axis');
		panelModel.open();
	...
	function mainLoop(now) {
		...
		renderer.totalTime = fixedTotalTime;
